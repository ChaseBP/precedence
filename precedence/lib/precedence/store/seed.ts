...
export function seedHistory(): { races: PriorityRace[]; attestations: Attestation[] } {
  ...
  const settledRace: PriorityRace = {
    ...
    waterfall: {
      realizedRepaymentUsd: 7790,
      protocolFeeUsd: 19.48,
      proverFeeUsd: 3.9,
      distributableUsd: 7766.62,
      kind: "REPAYMENT",
      lines: [
        {
          agentId: "meridian",
          ...
          priorityRank: 1,
          contributedUsd: 5100,
          interestDueUsd: 65.39,
          interestEarnedUsd: 65.39,
        ...
        },
        {
          ...
          priorityRank: 2,
          contributedUsd: 2550,
          interestDueUsd: 49.04,
          interestEarnedUsd: 49.04,
