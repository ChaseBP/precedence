  ...
  return [
    {
      ...
      obligorAddress: ("0xSAMPLE_OBLIGOR_ATLAS_" + "a1".repeat(10)) as `0x${string}`,
    ...
    },
    {
      ...
      obligorAddress: ("0xSAMPLE_OBLIGOR_APEX_" + "a2".repeat(11)) as `0x${string}`,
    ...
    },
    {
      ...
      obligorAddress: ("0xSAMPLE_OBLIGOR_HRZN_" + "a3".repeat(11)) as `0x${string}`,
    ...
    },
    {
      ...
      obligorAddress: ("0xSAMPLE_OBLIGOR_GLBM_" + "a4".repeat(11)) as `0x${string}`,
